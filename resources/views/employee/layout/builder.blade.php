                    ...
                    <div class="text-center">
                        <div class="custom-checkbox-card mb-2">
                            ...
                            <label class="custom-checkbox-card-label" for="layoutSkinsRadio1">
                                <img class="custom-checkbox-card-img" src="/frontend/assets\svg\layouts\layouts-sidebar-default.svg" alt="Image Description">
                            </label>
                    ...
                    <div class="text-center">
                        <div class="custom-checkbox-card mb-2">
                            ...
                            <label class="custom-checkbox-card-label" for="layoutSkinsRadio2">
                                <img class="custom-checkbox-card-img" src="/frontend/assets\svg\layouts\layouts-sidebar-dark.svg" alt="Image Description">
                            </label>
                    ...
                    <div class="text-center">
                        <div class="custom-checkbox-card mb-2">
                            ...
                            <label class="custom-checkbox-card-label" for="layoutSkinsRadio3">
                                <img class="custom-checkbox-card-img" src="/frontend/assets\svg\layouts\layouts-sidebar-light.svg" alt="Image Description">
                            </label>
                    ...
                    <div class="text-center">
                        <div class="custom-checkbox-card mb-2">
                            ...
                            <label class="custom-checkbox-card-label" for="sidebarLayoutOptions1">
                                <img class="custom-checkbox-card-img" src="/frontend/assets\svg\layouts\sidebar-default-classic.svg" alt="Image Description">
                            </label>
                            <span class="custom-checkbox-card-text">Default</span>
                        </div>
                    </div>
                    ...
                    <div class="text-center">
                        <div class="custom-checkbox-card mb-2">
                            ...
                            <label class="custom-checkbox-card-label" for="sidebarLayoutOptions2">
                                <img class="custom-checkbox-card-img" src="/frontend/assets\svg\layouts\sidebar-compact.svg" alt="Image Description">
                            </label>
                    ...
                    <div class="text-center">
                        <div class="custom-checkbox-card mb-2">
                            ...
                            <label class="custom-checkbox-card-label" for="sidebarLayoutOptions3">
                                <img class="custom-checkbox-card-img" src="/frontend/assets\svg\layouts\sidebar-mini.svg" alt="Image Description">
                            </label>
                    ...
                    <div class="text-center">
                        <div class="custom-checkbox-card mb-2">
                            ...
                            <label class="custom-checkbox-card-label" for="headerLayoutOptions1">
                                <img class="custom-checkbox-card-img" src="/frontend/assets\svg\layouts\header-default-fluid.svg" alt="Image Description">
                            </label>
                    ...
                    <div class="text-center">
                        <div class="custom-checkbox-card mb-2">
                            ...
                            <label class="custom-checkbox-card-label" for="headerLayoutOptions2">
                                <img class="custom-checkbox-card-img" src="/frontend/assets\svg\layouts\header-default-container.svg" alt="Image Description">
                            </label>
                    ...
                    <div class="text-center">
                        <div class="custom-checkbox-card mb-2">
                            ...
                            <label class="custom-checkbox-card-label" for="headerLayoutOptions3">
                                <img class="custom-checkbox-card-img" src="/frontend/assets\svg\layouts\header-double-line-fluid.svg" alt="Image Description">
                            </label>
                    ...
                    <div class="text-center">
                        <div class="custom-checkbox-card mb-2">
                            ...
                            <label class="custom-checkbox-card-label" for="headerLayoutOptions4">
                                <img class="custom-checkbox-card-img" src="/frontend/assets\svg\layouts\header-double-line-container.svg" alt="Image Description">
                            </label>
...
<div class="d-none d-md-block position-fixed bottom-0 right-0 mr-5 mb-10" style="z-index: 3;">
    <div style="position: fixed; top: 50%; right: 0; margin-right: -.25rem; transform: translateY(-50%); writing-mode: vertical-rl; text-orientation: sideways;">
        <div class="hs-unfold">
            <a id="builderPopover" class="js-hs-unfold-invoker btn btn-sm btn-soft-dark py-3" href="javascript:;" data-template='<div class="d-none d-md-block popover" role="tooltip"><div class="arrow"></div><h3 class="popover-header"></h3><div class="popover-body"></div></div>'
               data-toggle="popover" data-placement="left" title="<div class='d-flex align-items-center'>Front Builder <a href='#!' class='close close-light ml-auto'><i id='closeBuilderPopover' class='tio-clear'></i></a></div>" data-content="Customize your overview page layout. Choose the one that best fits your needs."
