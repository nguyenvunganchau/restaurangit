                        ...
                        <tbody>
                            @foreach ($table_type as $key => $val)
                                <tr>
                                    ...
                                    <td>
                                        <div>
                                            <img src="{{ asset($val->image_table_type) ? '' . Storage::url($val->image_table_type) : $val->name }}"
                                    ...
                                    <td>
                                        <a class="btn btn-sm btn-primary"
                                            href="{{ route('edit_table_type.get', $val->table_type_id) }}">
                                            <i class="tio-edit"></i>
                                        </a>
                                        <a class="btn btn-sm btn-danger"
                                            href="{{ route('table_type.delete', $val->table_type_id) }}"
