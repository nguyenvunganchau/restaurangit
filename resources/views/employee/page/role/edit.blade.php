    ...
    <div class="content container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-lg-10">
                ...
                <div class="card">
                    <!-- Body -->
                    <form method="post" action="{{ route('update_role.post', ['id' => request()->route('id')]) }}">
                        @csrf
                        <div class="card-body">

                            <div class="form-group">
                                <label for="addresszipCodeLabel" class="input-label">Tên Quyền <span
                                        class="text-danger">*</span></label>

                                <input type="text" class="js-masked-input form-control" name="name"
                                    id="addresszipCodeLabel" value="{{ isset($role) ? $role->name : old('name') }}">
                                @error('name')
                                    <div>
                            ...
                            <div class="d-flex justify-content-end">
                                ...
                                <a href="{{ route('show_list_role.index') }}"
