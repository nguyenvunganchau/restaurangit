            ...
            <div class="page-header">
                <div class="row align-items-end">
                    <div class="col-sm mb-2 mb-sm-0">
                        ...
                        <h1 class="page-header-title">Bài viết</h1>
                    </div>

                    <div class="col-sm-auto">
                        <a class="btn btn-primary" href="{{ route('show_create_new.index') }}">
                        ...
                        <tbody>
                            @foreach ($new as $key => $val)
                                <tr>
                                    ...
                                    <td>
                                        <div>
                                            <img src="{{ asset($val->image_news) ? '' . Storage::url($val->image_news) : $val->title }}"
                                                alt="" class="avatar-sm rounded-circle me-2">
                                        </div>
                                    </td>
                                    <td>{{ $val ? $val->title : '' }}</td>
                                    <td>
                                        <a class="btn btn-sm btn-primary" href="{{ route('edit_new.get', $val->new_id) }}">
                                            <i class="tio-edit"></i>
                                        </a>
                                        <a class="btn btn-sm btn-danger" href="{{ route('new.delete', $val->new_id) }}"
