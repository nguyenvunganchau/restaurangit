                    ...
                    <div class="col-sm mb-2 mb-sm-0">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb breadcrumb-no-gutter">
                                ...
                                <li class="breadcrumb-item"><a class="breadcrumb-link" href="javascript:;">Tin nhắn phản
                                        hồi</a></li>
                        ...
                        <tbody>
                            @foreach ($message as $key => $val)
                                <tr>
                                    ...
                                    <td>{{ $val ? $val->name_customer : '' }}</td>
                                    <td>{{ $val ? $val->email : '' }}</td>
                                    <td>{{ $val ? $val->subject : '' }}</td>
                                    {{-- <td>{{ $val ? $val->message : '' }}</td> --}}
                                    <td>{{ $val ? $val->created_at->setTimezone('Asia/Ho_Chi_Minh')->format('H:i d/m/Y') : '' }}
                                    </td>
                                    <td>
                                        @if ($val->status == 'pending')
                                            <span class="text-warning">Chưa phản hồi</span>
                                    ...
                                    <td><a class="btn btn-sm btn-primary" href="{{ route('edit_message.get', $val->id) }}">
                                            <i class="tio-edit"></i>
                                        </a></td>
                                </tr>
                            @endforeach
